      ...
      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <Link :href="route('dashboard')" class="flex-1 ms-3 whitespace-nowrap">Dashboard</Link>
            </a>
         </li>
         <li>
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <Link :href="route('sli/user')" class="flex-1 ms-3 whitespace-nowrap">Assit Monitoring</Link>
