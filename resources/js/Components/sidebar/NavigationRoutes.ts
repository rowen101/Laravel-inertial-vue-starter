...
export default {
  routes: [
    ...
    //System Administration
    {
      ...
      children: [
        ...
        },
        {
          ...
          displayName: 'menu.change_warehouse',
        },
        {
          name: 'printer',
          displayName: 'menu.printer',
        },
      ],
    },
    ...
    //storage management
    {
      ...
      displayName: 'menu.storage_management',
      meta: {
        icon: 'folder_shared',
      },
      children: [
        {
          name: 'stock_transfer',
          displayName: 'menu.stock_transfer',
        },
        {
          name: 'stock_transfer_picklist',
          displayName: 'menu.stock_transfer_picklist',
        },
        {
          name: 'stock_transfer_confirm',
          displayName: 'menu.stock_transfer_confirm',
        },
      ],
    },
    //outbound
    ...
    //upload data
    {
      ...
      children: [
        ...
        },
        {
          ...
          displayName: 'menu.customer_upload',
        },
      ],
    },
    //data maintenance
